# Migration `20200621172701-init`

This migration has been generated by Angad Singh at 6/21/2020, 5:27:01 PM.
...
`createdAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ,`id` int NOT NULL  AUTO_INCREMENT,`levelId` int  ,`number` int   ,`story` json   ,`type` ENUM('STORY', 'LEVEL', 'RAND_PERSON', 'RAND_CHANCE', 'GO', 'JAIL', 'GATE', 'GATEI', 'MYSTERY', 'CENTER') NOT NULL  ,`updatedAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ,
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci
...
CREATE TABLE `cryptocracy`.`GameConfig` (
`createdAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ,`id` int NOT NULL  AUTO_INCREMENT,`key` varchar(191) NOT NULL  ,`updatedAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ,`value` json NOT NULL  ,
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci

CREATE TABLE `cryptocracy`.`Inventory` (
`createdAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ,`hex` varchar(191) NOT NULL  ,`id` int NOT NULL  AUTO_INCREMENT,`item` varchar(191) NOT NULL  ,`updatedAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ,`used` boolean NOT NULL DEFAULT false ,`userId` int NOT NULL ,
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci
...
CREATE UNIQUE INDEX `GameConfig.key` ON `cryptocracy`.`GameConfig`(`key`)
...
ALTER TABLE `cryptocracy`.`Inventory` ADD FOREIGN KEY (`userId`) REFERENCES `cryptocracy`.`User`(`id`) ON DELETE CASCADE ON UPDATE CASCADE
